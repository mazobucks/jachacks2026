...
from wtforms import StringField, FloatField, DateField, IntegerField, SelectField, TextAreaField
...
class GoalForm(FlaskForm):
    ...
    hours_willing = FloatField('Planned Study Hours', validators=[DataRequired(), NumberRange(min=0.1)])
